...
type FetchMissingTransaction struct {
	...
	HashList       []string `protobuf:"bytes,5,rep,name=hash_list,json=hashList" json:"hash_list,omitempty"`
...
func (m *FetchMissingTransaction) GetVid() uint64 {
	if m != nil {
		return m.Vid
	}
	return 0
...
type ReturnMissingTransaction struct {
	...
	BatchDigest    string               `protobuf:"bytes,4,opt,name=batch_digest,json=batchDigest" json:"batch_digest,omitempty"`
	HashList       []string             `protobuf:"bytes,5,rep,name=hash_list,json=hashList" json:"hash_list,omitempty"`
	TxList         []*types.Transaction `protobuf:"bytes,6,rep,name=tx_list,json=txList" json:"tx_list,omitempty"`
...
func (m *ReturnMissingTransaction) GetVid() uint64 {
	if m != nil {
		return m.Vid
	}
	return 0
...
var fileDescriptor0 = []byte{
	...
	,
}
