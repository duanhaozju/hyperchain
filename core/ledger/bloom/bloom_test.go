...
func (suite *BloomSuite) TestBuildInTimeScope(c *checker.C) {
	...
	db_utils.PersistBlock(db.NewBatch(), block, true, true)
	db_utils.UpdateChain(ns, db.NewBatch(), block, false, true, true)
