...
public class TestContractClassLoader {
    ...
    public void testReLoadClass() {
        ...
        try{
            ContractTemplate c1 = (ContractTemplate) loader.loadClass("cn.hyperchain.jcee.contract.examples.c2.ReloadableContract").newInstance();
            ...
            ContractTemplate c2 = (ContractTemplate) loader2.loadClass("cn.hyperchain.jcee.contract.examples.c2.ReloadableContract").newInstance();
