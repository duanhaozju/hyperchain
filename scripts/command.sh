...
curl localhost:8081 --data '{"jsonrpc":"2.0","method":"tx_sendTransaction","params":[{"from":"0x000f1a7a08ccc48e5d30f80850cf1cf283aa3abd","to":"0x0000000000000000000000000000000000000003","value":"0x01","timestamp":1478957107214729696}],"id":1}'
curl localhost:8081 --data '{"jsonrpc":"2.0","method":"tx_sendTransaction","params":[{"from":"0x000f1a7a08ccc48e5d30f80850cf1cf283aa3abd","to":"0x0000000000000000000000000000000000000003","value":"0x01","timestamp":1478957107214729696, "signature":"test signature"}],"id":1}'
# 有request —— 用于Dashboard测试
curl localhost:8081 --data '{"jsonrpc":"2.0","method":"tx_sendTransaction","params":[{"from":"4762d4f39099727dc58d1cec8d8f80f5c683a054","to":"0x0000000000000000000000000000000000000003","value":1,"timestamp":1478957107214729696,"signature":"test signature","request":10}],"id":1}'
...
# 获取签名哈希 GetSignHash
curl localhost:8081 --data '{"jsonrpc":"2.0","method":"tx_getSignHash","params":[{"from":"0x000f1a7a08ccc48e5d30f80850cf1cf283aa3abd","to":"0x0000000000000000000000000000000000000003","value":"0x01"，"timestamp":1478957107214729696}],"id":1}'
...
################################ contract 服务 #################################
#　部署合约 DeployContract
curl localhost:8081 --data '{"jsonrpc":"2.0","method":"contract_deployContract","params":[{"from":"0x000f1a7a08ccc48e5d30f80850cf1cf283aa3abd","timestamp":1478957107214729696,"payload":"","privKey":"c2c1149d93f52d586b4ab9d9b634bf9b0221a2f6b78710d58bcbe417482884ca"}],"id":1}'
...
curl localhost:8081 --data '{"jsonrpc":"2.0","method": "contract_invokeContract","params": [{"from": "<caller address>", "to": "<contract address>", "timestamp":1478957107214729696, "payload": "<encode data>"}],"id": 1}'
