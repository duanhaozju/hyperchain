...
curl localhost:8081 --data '{"method":"tx_sendTransaction","params":[{"from":"0x000f1a7a08ccc48e5d30f80850cf1cf283aa3abd","to":"0x0000000000000000000000000000000000000003","value":"0x9184e72a"}],"id":1}'

#　部署合约 SendTransactionOrContract
curl localhost:8081 --data '{"method":"tx_sendTransactionOrContract","params":[{"from":"0x000f1a7a08ccc48e5d30f80850cf1cf283aa3abd","payload":"contract Accumulator{ uint sum = 0; function increment(){ sum = sum + 1; } function getSum() returns(uint){ return sum; }}"}],"id":1}'
