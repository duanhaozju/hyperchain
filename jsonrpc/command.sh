...
######### 批量调用例子 #########
curl localhost:8081 --data '[{"method":"block_lastestBlock","params":[],"id":1}, {"method": "node_getNodes","id": 2}]'
