...
contract UserInfo{
  ...
  bytes32 idNum;
    ...
    function UserInfo(bytes32 _id,bytes32 _companyName,bytes32 _userName,bytes32 _phoneNum,bytes32 _idNum){
       id=_id;
    ...
    function getUserInfo()constant returns(bytes32,bytes32,bytes32,bytes32,bytes32){
...
contract Bank{
  ...
  function createApplicant(address companyAddr,bytes32 companyId,bytes32 companyName,bytes32 applicantId,bytes32 applicantName)onlyOwner{
...
contract Applicant is CommonOperations,DraftStructs{
  ...
  function Applicant(address _bankAddr,address _companyAddr,bytes32 companyId,bytes32 companyName,bytes32 applicantId,bytes32 applicantName){
     bankAddr=_bankAddr;
