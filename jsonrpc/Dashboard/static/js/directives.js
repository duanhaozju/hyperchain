    ...
    return {
        link: function(scope, element) {
            var listener = function(event, toState, toParams, fromState, fromParams) {
                ...
                var title = 'Hyperchain | Responsive Admin Theme';
                // Create your own title pattern
                if (toState.data && toState.data.pageTitle) title = 'Hyperchain | ' + toState.data.pageTitle;
                $timeout(function() {
                    element.text(title);
                });
            };
    ...
    return {
        ...
        link: function($scope, element, attrs) {
            ...
            var resize = function() {
                ...
                console.log($scope.initialHeight)
