...
type ContractEx struct {
	namespace   string
	tokenBucket *ratelimit.Bucket
	config      *common.Config
}

func NewContarctExAPI(namespace string, config *common.Config) *ContractEx{
...
func (contract *ContractEx) CompileContract(ct string) (*CompileCode, error) {
...
func (contract *ContractEx) GetCode(addr common.Address) (string, error) {
...
func (contract *ContractEx) GetContractCountByAddr(addr common.Address) (*Number, error) {
...
func (contract *ContractEx) EncryptoMessage(args EncryptoArgs) (*HmResult, error) {
...
func (contract *ContractEx) CheckHmValue(args CheckArgs) (*HmCheckResult, error) {
...
func (contract *ContractEx) GetDeployedList(addr common.Address) ([]string, error) {
	stateDb, err := getBlockStateDb(contract.namespace, contract.config)
	if err != nil {
		return nil, err
	}
...
func (contract *ContractEx) GetCreator(addr common.Address) (common.Address, error) {
	stateDb, err := getBlockStateDb(contract.namespace, contract.config)
	if err != nil {
...
func (contract *ContractEx) GetStatus(addr common.Address) (string, error) {
	stateDb, err := getBlockStateDb(contract.namespace, contract.config)
	if err != nil {
		return "", err
	}
...
func (contract *ContractEx) GetCreateTime(addr common.Address) (string, error) {
	stateDb, err := getBlockStateDb(contract.namespace, contract.config)
	if err != nil {
		return "", err
	}
